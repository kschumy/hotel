...
#       conflicts_with?(test_dates_1, @default_dates).must_equal true
#       conflicts_with?(@default_dates, test_dates_1).must_equal true
#
#       # ok after but overlaps in mid
#       test_dates_2 = DateRange.new(Date.new(2018,2,6), Date.new(2018,2,9))
#       conflicts_with?(test_dates_2, @default_dates).must_equal true
#       conflicts_with?(@default_dates, test_dates_2).must_equal true
#
#       # fits between start and end dates
#       test_dates_3 = DateRange.new(Date.new(2018,2,5), Date.new(2018,2,6))
#       conflicts_with?(test_dates_3, @default_dates).must_equal true
#       conflicts_with?(@default_dates, test_dates_3,).must_equal true
#
#       # completely overlaps other reservation
#       test_dates_4 = DateRange.new(Date.new(2018,2,1), Date.new(2018,2,9))
#       conflicts_with?(test_dates_4, @default_dates).must_equal true
#       conflicts_with?( @default_dates, test_dates_4).must_equal true
#     end
#
#     it 'returns \'false\' if does not conflict with reservation' do
#       # ends day before
#       test_dates_1 = DateRange.new(Date.new(2018,2,1), Date.new(2018,2,2))
#       conflicts_with?(test_dates_1, @default_dates).must_equal false
#       conflicts_with?(@default_dates, test_dates_1).must_equal false
#
#       # starts day after
#       test_dates_2 = DateRange.new(Date.new(2018,2,8), Date.new(2018,2,9))
#       conflicts_with?(test_dates_2, @default_dates).must_equal false
#       conflicts_with?(@default_dates, test_dates_2).must_equal false
#     end
#
...
#         conflicts_with?(bad_test_dates_1, @default_dates)
#       }.must_raise ArgumentError
#
#       proc {
#         end_date = "Look at me. I am the end date now"
#         bad_test_dates_1 = DateRange.new(Date.new(2018,2,1), end_date)
#         conflicts_with?(@default_dates, bad_test_dates_1)
#       }.must_raise ArgumentError
#
#       proc {
#         start_date = "Look at me. I am the start date now"
#         bad_test_dates_2 = DateRange.new(start_date, Date.new(2018,2,1))
#         conflicts_with?(bad_test_dates_2, @default_dates)
#       }.must_raise ArgumentError
#
#       proc {
#         start_date = "Look at me. I am the start date now"
#         bad_test_dates_2 = DateRange.new(start_date, Date.new(2018,2,1))
#         conflicts_with?(@default_dates, bad_test_dates_2)
#       }.must_raise ArgumentError
#
#     end
#
