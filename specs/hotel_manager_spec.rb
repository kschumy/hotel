...
describe 'HotelManager class' do
  ...
  #     @manager.is_available?(Date.new(2018,2,9), Date.new(2018,2,11)).must_equal true
  #   end
  #
  #   it 'returns true if available on another reservation end date' do
  #     @manager.is_available?(Date.new(2018,2,8), Date.new(2018,2,11)).must_equal true
  #   end
  #
  #   it 'returns true if end date is on another reservation start date' do
  #     @manager.is_available?(Date.new(2018,2,9), Date.new(2018,2,12)).must_equal true
  #   end
  #
  #   it 'returns true of starts/ends overlap with two reservations' do
  #     @manager.is_available?(Date.new(2018,2,8), Date.new(2018,2,12)).must_equal true
  #   end
  #
  #   it 'returns false if overlaps on non-start/end dates' do
  #     @manager.is_available?(Date.new(2018,2,9), Date.new(2018,2,13)).must_equal false
  #   end
  #
  #   it 'returns false if overlaps on non-start/end dates' do
  #     @manager.is_available?(Date.new(2018,2,7), Date.new(2018,2,11)).must_equal false
  #   end
  #
  #   # it 'throws error if the reservation is not a Reservation' do
  #   #   proc {
  #   #     @manager.is_available?("foo", Date.new(2018,2,11))
  #   #   }.must_raise ArgumentError
  #   # end
